...
def main():
    ...
    try:
        ...
        json_file = os.path.join(project_root, "questions_data", "v2.json")
        ...
        # Save the paper
        output_file = os.path.join(project_root, "outputs", "v2_paper.pdf")
        ...
        if answer_choice == 'y':
            ...
            answer_file = os.path.join(project_root, "outputs", "v2_paper_answers.pdf")
